...
namespace EmployeeApp.Infrastructure.Contexts
{
    public class PlayGroundContext : IdentityDbContext<ApplicationUser, IdentityRole<Guid>, Guid>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<IdentityUserToken<Guid>>().ToTable("asp_net_user_tokens");//Represents an authentication token for a user usually for external logins like google.
